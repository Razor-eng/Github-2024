...
const Hero = () => {
    ...
    return (
        <div className='relative max-w-[1280px] lg:pt-32 md:px-10 mx-auto pt-16'>
            <img className='absolute hero-drone top-28 w-1/4 h-auto right-0 xl:right-0' width="500" height="326" src="/images/home/hero/hero-drone.webp" alt="" />
            <div className='flex'>
                <div className='relative '>
                    <img aria-hidden="true" className='' src="/images/home/hero/lines-hero.svg" width="437" height="637" alt="" />
                ...
                <div className=' absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12'>
                    <div className='relative md:top-20 mb-[24px]'>
                        <a onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} href="" className=' border-[1px] border-neutral-600 copilot rounded-full inline-block'>
                            <div className='flex items-center p-3 px-5'>
                                <img className=" d-block w-auto flex-grow-0 flex-shrink-0 mr-6 max-md:mr-3 scale-110" width="44" height="44" loading="lazy" decoding="async" alt="" aria-hidden="true" src="/images/home/hero/eyebrow-banner-icon-copilot-x.svg" />
                                <div className='md:pr-5 pr-3 md:mr-2 md:pl-2'>
                                    <div className='font-medium text-white sm:text-[16px] text-xs leading-5'>Introducing GitHub Copilot X</div>
                                    <div className='text-neutral-500 text-[8px] sm:text-[16px]'>Your Ai pair programmer is leveling Up</div>
                                </div>
                    ...
                    <div className='flex lg:w-11/12 md:space-x-5 max-md:flex-col'>
                        <form action="">
                            <div className='grid max-md:grid-rows-2 md:w-[500px] md:grid-cols-3'>
                    ...
                    <div className='md:my-32 my-24'>
                        ...
                        <div className="flex flex-wrap justify-between items-center">
                            <img src="/images/home/hero/stripe.svg" alt="Stripe logo" height="44" className="my-3 scale-90" />
                            <img src="/images/home/hero/pinterest.svg" alt="Pinterest logo" height="44" className="my-3 scale-90" />
                            <img src="/images/home/hero/kpmg.svg" alt="KPMG logo" height="44" className="my-3 scale-90" />
                            <img src="/images/home/hero/mercedes.svg" alt="Mercedes-Benz logo" height="44" className="my-3 w-[200px]" />
                            <img src="/images/home/hero/pg.svg" alt="P&amp;G logo" height="32" className="my-3 scale-90" />
                            <img src="/images/home/hero/telus.svg" alt="Telus logo" height="32" className="my-3 scale-90" />
                        </div>
                    </div>
                </div>
            </div>
