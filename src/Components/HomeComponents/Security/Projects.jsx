...
const Projects = () => {
    ...
    return (
        <div className='flex relative md:pl-10'>
            <img alt="" aria-hidden="true" width="2712" height="2712" className="absolute top-0 right-0 h-auto pointer-events-none" loading="lazy" decoding="async" src="/images/home/security/bg-stars-1.webp" />
            <div className='flex items-center flex-row relative'>
                ...
                <img
                    ...
                    loading="lazy"
                    decoding="async"
                    src="/images/home/security/git-branch-security.svg"
                />
            </div>
                        ...
                        <div className='relative'>
                            <div className='relative'>
                                <div className='md:absolute z-[1] top-[-100px] lg:top-[-200px] right-0 shadow-2xl'>
                                    <img src="/images/home/security/illu-ghas-list.png" alt="" loading="lazy" decoding="async" width="1190" height="1004" className="w-full h-auto d-block rounded-lg" />
                                </div>
                            </div>
                        </div>
                    </motion.div>
