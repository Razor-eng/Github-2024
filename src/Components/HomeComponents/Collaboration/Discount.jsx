...
const Discount = () => {
    ...
    return (
        <div className='flex relative md:pl-10'>
            <img alt="" aria-hidden="true" width="2712" height="2712" className="absolute top-0 right-0 h-auto pointer-events-none" loading="lazy" decoding="async" src="/images/home/collaboration/bg-stars-1.webp" />
            <div className='flex items-center flex-row relative'>
                ...
                <img
                    ...
                    loading="lazy"
                    decoding="async"
                    src="/images/home/collaboration/git-branch-collaboration.svg"
                />
            </div>
                        ...
                        <div className='relative'>
                            <div className='relative'>
                                <div className='md:absolute z-[1] top-[-200px] lg:top-[-300px] right-0 shadow-2xl'>
                                    <img src="/images/home/collaboration/illu-projects.png" alt="" loading="lazy" decoding="async" width="1190" height="1004" className="w-full h-auto d-block rounded-lg" />
                                </div>
                            </div>
                        </div>
                    </motion.div>
