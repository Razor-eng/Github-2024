...
const Collaboration = () => {
    ...
    return (
        <div className='max-w-[1280px] mx-auto'>
            ...
            <img className="w-full h-auto d-block rounded-lg border-[1px] border-[#30363d]  " width="2500" height="1500" loading="lazy" decoding="async" alt="Illustration of project table view with cards grouped by 'Feature planning' phase." src="/images/home/collaboration/issues-plan.png" />
            <Discount />
                ...
                <div className='flex justify-between md:space-x-10 max-md:flex-col'>
                    <HoverCard backgroundColor='#ffa28b' direction='flex-col' left='0'>
                        ...
                        <motion.div initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ type: 'tween', duration: 0.3 }} className='overflow-hidden rounded-s-lg'>
                            <img className="w-full h-auto" width="1209" height="890" loading="lazy" decoding="async" alt="" aria-hidden="true" src="/images/home/collaboration/illu-discussions.webp?width=1208&format=webpll" />
                        </motion.div>
                    </HoverCard>
                    <HoverCard backgroundColor='#ffa28b' direction='flex-col' left='-400px'>
                        ...
                        <div className='overflow-hidden rounded-s-lg'>
                            <motion.img initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ type: 'tween', duration: 0.3 }} className="w-full h-auto" width="1208" height="764" loading="lazy" decoding="async" alt="" aria-hidden="true" src="/images/home/collaboration/illu-pull-requests.webp?width=1208&format=webpll" />
                        </div>
                    </HoverCard>
                </div>
            </div>
                    ...
                    <motion.div variants={container} initial='hidden' whileInView='show' className='flex flex-wrap w-full relative -top-[120px] -rotate-12 -right-6 -mt-6  p-6 max-h-[480px]'>
                        <motion.div variants={item} transition={{ type: 'tween' }} className='w-1/3 '>
                            <a href="" target='_blank' className='rounded-md bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                                <img alt="Homebrew avatar" width="96" height="96" className="d-block rounded-md" loading="lazy" decoding="async" src="/images/home/collaboration/homebrew.png" />
                        ...
                        <motion.div variants={item} transition={{ type: 'tween' }} className='w-1/3 '>
                            <a href="" target='_blank' className='rounded-md  bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                                <img alt="Homebrew avatar" width="96" height="96" className=" rounded-md" loading="lazy" decoding="async" src="/images/home/collaboration/directus.png" />
                        ...
                        <motion.div variants={item} transition={{ type: 'tween' }} className='w-1/3 '>
                            <a href="" target='_blank' className='rounded-md  bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                                <img alt="Homebrew avatar" width="96" height="96" className=" rounded-md" loading="lazy" decoding="async" src="/images/home/collaboration/dayhaysoos.jpeg" />
                        ...
                        <motion.div variants={item} transition={{ type: 'tween' }} className='w-1/3 '>
                            <a href="" target='_blank' className='rounded-md  bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                                <img alt="Homebrew avatar" width="96" height="96" className=" rounded-md" loading="lazy" decoding="async" src="/images/home/collaboration/imolorhe.jpeg" />
                        ...
                        <motion.div variants={item} transition={{ type: 'tween' }} className='w-1/3 '>
                            <a href="" target='_blank' className='rounded-md  bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                                <img alt="Homebrew avatar" width="96" height="96" className=" rounded-md" loading="lazy" decoding="async" src="/images/home/collaboration/commandpost.png" />
                        ...
                        <motion.div variants={item} transition={{ type: 'tween' }} className='w-1/3 '>
                            <a href="" target='_blank' className='rounded-md  bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                                <img alt="Homebrew avatar" width="96" height="96" className="rounded-md" loading="lazy" decoding="async" src="/images/home/collaboration/kazupon.jpeg" />
                        ...
                        <motion.div variants={item} transition={{ type: 'tween' }} className='w-1/3 '>
                            <a href="" target='_blank' className='rounded-md bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                                <img alt="Homebrew avatar" width="96" height="96" className="rounded-md" loading="lazy" decoding="async" src="/images/home/collaboration/prophen.jpeg" />
                        ...
                        <motion.div variants={item} transition={{ type: 'tween' }} className='w-1/3 '>
                            <a href="" target='_blank' className='rounded-md  bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                                <img alt="Homebrew avatar" width="96" height="96" className="rounded-md" loading="lazy" decoding="async" src="/images/home/collaboration/sindresorhus.jpeg" />
                        ...
                        <motion.div variants={item} transition={{ type: 'tween' }} className='w-1/3 '>
                            <a href="" target='_blank' className='rounded-md  bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6'>
                                <img alt="Homebrew avatar" width="96" height="96" className="rounded-md" loading="lazy" decoding="async" src="/images/home/collaboration/eslint.png" />
