...
const CodeSpace = () => {
    ...
    return (
        <div className='flex relative md:pl-10'>
            <img alt="" aria-hidden="true" width="2712" height="2712" className="absolute top-0 right-0 h-auto pointer-events-none" loading="lazy" decoding="async" src="/images/home/productivity/bg-stars-1.webp" />
            <div className='flex items-center flex-row relative'>
                ...
                <img
                    ...
                    loading="lazy"
                    decoding="async"
                    src="/images/home/productivity/git-branch-productivity.svg"
                />
            </div>
                        ...
                        <div className='relative'>
                            <div className='flex flex-row relative'>
                                <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ type: "tween" }} className='sm:absolute z-[1] top-[-200px] right-7 shadow-2xl'>
                                    <img src="/images/home/productivity/pic.png" alt="" loading="lazy" decoding="async" className=" w-[300px] h-auto rounded-md" />
                                    <img
                                        src="/images/home/productivity/illo-cursor.png"
                                        alt=""
                                        loading="lazy"
                                        decoding="async"
                                ...
                                <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ type: "tween", delay: 0.1 }} className=" overflow-hidden max-w-[373px] bottom-0 rounded-md relative hidden sm:block build-in-animate" >
                                    <img
                                        src="/images/home/productivity/illo-ports.png"
                                        loading="lazy"
                                        width="746"
                                        height="368"
                                        alt=""
