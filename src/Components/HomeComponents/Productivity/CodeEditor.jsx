            ...
            <div className='flex items-stretch'>
                ...
                <div className='md:block hidden border-l-[0.5px] border-[#30363d] w-full'>
                    ...
                    <div className='px-6 flex items-center justify-between h-full bg-[#040d21]'>
                        <img className="w-full h-auto md:block" width="1238" height="1404" loading="lazy" decoding="async" alt="Planet earth with visualization of GitHub activity crossing the globe" src="/images/home/productivity/globe.jpg" />
                    </div>
                </div>
            </div>
        </div>
