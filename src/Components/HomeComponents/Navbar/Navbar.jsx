...
const Navbar = () => {
    ...
    return (
        <div className="w-screen xl:px-20 md:px-8 sm:px-7 mx-auto">
            <div className='text-white bg-transparent py-5'>
                ...
                <div className='flex items-center max-lg:justify-between max-lg:flex-row-reverse'>
                    <div className='flex justify-between items-center max-lg:w-full px-2 sm:px-0'>
                        <div className='lg:hidden'>
                            <Link to={"/signup"} className='px-2 py-[6px] border-[1px] rounded-md hover:text-neutral-400'>Sign up</Link>
                        </div>
                        <Link to="/">
                    ...
                    <div className={`flex w-full max-lg:absolute transition ease-in duration-200 top-20 z-40  ${showNav ? "max-lg:translate-x-0 max-lg:scale-100" : "max-lg:max-h-0 max-lg:scale-y-50 max-lg:-translate-y-1/4"}`}>
                        <div className='flex w-full max-lg:flex-col lg:items-center lg:justify-between max-lg:justify-between max-sm:w-10/12 max-sm:mx-auto sm:ml-auto max-lg:w-[320px] lg:w-full max-lg:max-h-[500px]  overflow-y-auto lg:mb-0 max-lg:bg-white max-lg:rounded-lg'>
                            ...
                            <div className='lg:flex items-center max-lg:flex-col lg:px-0 px-3 mb-3 lg:mb-0 text-left lg:space-x-4'>
                                ...
                                <Link to={'/signin'} className='max-lg:flex justify-center max-lg:border-[1px] max-lg:mr-4 rounded-md max-lg:bg-neutral-800'>
                                    <a href="" className='hover:text-neutral-400 max-lg:py-2 max-lg:text-[16px] max-lg:font-semibold '>Sign in</a>
                                </Link>
                                <Link to={'/signup'} className='max-lg:hidden px-2 py-[5px] border-[1px] rounded-md hover:text-neutral-400 '>Sign up</Link>
                            </div>
                        </div>
                    </div>
                </div>
