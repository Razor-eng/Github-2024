import Hero from "../Components/HomeComponents/Hero-section/Hero";
import Productivity from "../Components/HomeComponents/Productivity/Productivity";
import Navbar from "../Components/HomeComponents/Navbar/Navbar";
import StickyNav from "../Components/HomeComponents/Navbar/StickyNav";
import Collaboration from "../Components/HomeComponents/Collaboration/Collaboration";
import Security from "../Components/HomeComponents/Security/Security";
import Globe from "../Components/HomeComponents/Globe/Globe";
            ...
            <div>
                <div className='overflow-hidden'>
                    <div className='relative'>
                        <img className='absolute top-0 transition ease-in duration-200 max-xl:right-[-1050px] xl:right-[-970px] -z-30 image' width='4377' src="/images/home/hero/hero-bg.webp" alt="" />
                    </div>
